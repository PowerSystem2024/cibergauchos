    ...
    nombreComleto(){//metodo para devolver el nombre.
        return this._nombre + ' '+ this._apellido; // Devolvemos el nombre y el aplledio separado con un espacio.
    }
  }
  ...
  console.log(empleado1.nombreComleto())
