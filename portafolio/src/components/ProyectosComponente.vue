<script setup>
import proyecto1 from '/src/assets/mercado.png';
import proyecto2 from '/src/assets/dinosaurio.png';
import proyecto3 from '/src/assets/portafolio.png';
import proyecto4 from '/src/assets/tinder.png';
...
misProyectos.value = ([
    //esto es un array de objetos que contiene información sobre los proyectos
    {
        id: 1,
        src: proyecto1,
        titulo: "Mercado Libre. (2023)",
        descripcion: "Creamos una aplicacion de compra y venta nacional.",
        projectoLink: "https://www.mercadolibre.com.ar",
        githubLink: "https://github.com/"
    },
    {
        id: 2,
        src: proyecto2,
        titulo: "VideoJuego Dinosaurio Google (2016)",
        descripcion: "Fuimos parte del desarrollo del mítico juego de google del dinosaurio.",
        projectoLink: "https://poki.com/es/g/dinosaur-game",
        githubLink: "https://github.com"
    },
    {
        id: 3,
        src: proyecto3,
        titulo: "Portafolio personal.(2022)",
        descripcion: "Creamos un portafolio personal como parte de una carpeta para entregar en la TUP.",
        projectoLink: "https://github.com/PowerSystem2024/cibergauchos/tree/main/portafolio",
        githubLink: "https://github.com/PowerSystem2024/cibergauchos/tree/main/portafolio"
    },
    {
        id: 4,
        src: proyecto4,
        titulo: "Aplicación de Citas Online (2023)",
        descripcion: "Fuimos parte del desarrollo de una aplicacion dedicada a citas online.",
        projectoLink: "https://tinder.com/",
        githubLink: "https://github.com"
    },
])
