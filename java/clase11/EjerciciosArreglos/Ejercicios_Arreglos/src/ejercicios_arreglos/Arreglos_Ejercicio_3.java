...
public class Arreglos_Ejercicio_3 {
    public static void main(String[] args) {
        ...
        else{ //Mostrara la media de los numeros positivos 
        ...
        else{ //Mostrara la media de los numeros negativos
            mediaNegativos = negativos/conteo_negativos;
            System.out.println("La media de los numeros negativos es: "+mediaNegativos);
        }
        System.out.println("La cantidad de ceros es: "+conteo0);//Se muestran la cantidad de todos los ceros
